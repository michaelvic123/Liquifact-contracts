...
fn test_escrow_gold_standard_happy_path_open_overfund_snapshot_settle_claim() {
    ...
    // Bob contributes 30,000 USDC (60% of target) - this triggers funding completion (20k+30k=50k)
    let bob_amount = 30_000 * USDC_DECIMALS;
    ...
    assert_eq!(total_funded, TARGET_USDC);
